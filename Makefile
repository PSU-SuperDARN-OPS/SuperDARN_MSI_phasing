...
ATTEN_SOURCES=atten_calibration.c  _open_PLX9050.c utils.c vna_functions.c MSI_functions.c
...
OPTBEAM_SOURCES=optimize_beam_programming.c MSI_functions.c vna_functions.c utils.c phasing_cards.c _open_PLX9050.c
